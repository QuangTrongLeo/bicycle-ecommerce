...
export const productImages = [
    ...
    { id: 2, colorId: 2, imageUrl: product1 },
    { id: 3, colorId: 3, imageUrl: product1 },
    { id: 4, colorId: 4, imageUrl: product2 },
    { id: 5, colorId: 5, imageUrl: product2 },
    { id: 6, colorId: 6, imageUrl: product2 },
